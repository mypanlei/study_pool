...
created: 2026-06-19
description: "深入解析 AI Agent 核心概念，梳理从被动响应到常驻自治的演进历程，对比 Agent、传统编程、Workflow 的区别和适用场景。重点围绕 AI Agent 的演进、什么是 AI Agent？、Tools 注册与调用遵循什么标准格式？、什么是 Prompt Engineering？ 等内容展开。"
tags:
  - "clippings"
---
...
在成熟的 Agent 系统里，查监控、查日志、分析瓶颈这三步可以封装成一个 diagnose\_service\_performance Skill。LLM 只要调用这个 Skill，就能拿到结构化诊断摘要，不用每次都从原子步骤拆起。
