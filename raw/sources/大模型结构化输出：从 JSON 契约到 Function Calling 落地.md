...
created: 2026-06-19
description: "从“请返回 JSON”在生产环境为什么不可靠讲起，拆解 Structured Outputs、JSON Schema、Function Calling、MCP 与 Java 后端工具调用的工程落地。重点围绕 ⭐️ 为什么“请返回 JSON”不可靠？、⭐️ 怎样把 JSON 从格式要求变成工程契约？"
tags:
  - "llm"
  - "structured-output"
  - "function-calling"
