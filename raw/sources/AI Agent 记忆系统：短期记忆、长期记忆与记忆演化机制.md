...
source: "https://javaguide.cn/ai/agent/agent-memory.html"
author:
  - "[[Guide]]"
published: 2026-05-21
created: 2026-06-19
description: "分清 Agent 记忆的层级与表征（Token/参数/潜在），短长期记忆的读写链路、向量与 Markdown 选型，以及 Claude Code 等轻量化落地方式。重点围绕 Agent 的记忆系统是如何设计的？、主流的记忆技术架构有哪些？、记忆的高级演化机制有哪些？、如何优化长期记忆的检索效果？ 等内容展开。"
tags:
  - "clippings"
---
