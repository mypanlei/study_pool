...
![[raw/assets/e4c496c3060e824a01b5b34c05a20af2_MD5.jpg]]
...
![[raw/assets/3c8450de0e287315a18fc6bd60423938_MD5.jpg]]
...
![[raw/assets/2abc3c71abddd6e39e75c51c9622a367_MD5.jpg]]
...
openspec init
```
![[raw/assets/c3147b19f64be40d00e88037e3cc6037_MD5.jpg]]
...
![[raw/assets/fafc7b7655a40a7ebed9960c5a726aa5_MD5.jpg]]
...
![[raw/assets/db51f24697430cd31c9b960102d02769_MD5.jpg]]

在走读代码库总结系统架构时，Claude也会调用CodeX来协作完善文档内容。

![[raw/assets/60bf008a0a9093eab8e8743c86b0bc88_MD5.jpg]]

最终产出文档

![[raw/assets/bd643a370656ea2bacc847dc9738a7cf_MD5.jpg]]

## 阶段三：生成技术方案

基于阶段一和阶段二中产出的 **系统架构文档 与 Spec-PRD** ，我们调用 **“技术方案专家” SubAgent** 自动生成一份技术方案文档，为后续 AI 编码阶段提供 **可执行、可验证的实现指引** ，确保开发过程“写得对”而非仅“写得快”。

![[raw/assets/402e5f4416dc18b5c4f49ddc86c4d941_MD5.jpg]]

## 阶段四：创建变更提案

在前置准备中我们已经将OpenSpec初始化后，OpenSpec已经在Claude中为我们安装好了3个关键Command。

![[raw/assets/839e6ad745642d4832ac51aad96ac8b0_MD5.jpg]]
...
```
![[raw/assets/fe012dbcbb0c521593c02efce753c4a6_MD5.jpg]]
...
![[raw/assets/9d33147dba4480b06d6c5c2f5689f0f3_MD5.jpg]]

回答完毕之后，ai会根据我们提供的明确答案继续创建提案。

![[raw/assets/f310da76fd8f146db23ec021a2f9d7c8_MD5.jpg]]

此时将第一阶段写好的Spec-PRD的语雀链接给到claude，他会调用Yuque MCP读取内容并创建提案

> 💡 这里也可以把写好的Spec-PRD以MarkDown格式写好保存到本地，让Claude读取路径下的.md文件内容。

![[raw/assets/c181b4559a8b000931f4cc0164090b92_MD5.jpg]]

了解完毕后，ai开始编写proposal提案。

![[raw/assets/1f3844bf37fdbfb32870847107a8ca28_MD5.jpg]]

即使前期我们将Spec-PRD、项目架构文档、技术文档给到ai作为参考资料编写提案，但ai大概率还是能发现遗漏的待确定点。

![[raw/assets/576ac392cee859e8548b11b313e7d6b2_MD5.jpg]]

与ai进行1~2轮对话之后，ai会对需求（为什么做、怎么做，做哪里、范围、边界）有一个清晰的了解，并完善提案。

![[raw/assets/ff39dc913e60323dbc2114f7d75acf67_MD5.jpg]]
...
/openspec:apply
```
![[raw/assets/2fe2aeed217eaa5d8d1a5b7678444075_MD5.jpg]]

完成每个阶段之后，Claude会总结当前阶段变更的代码，并停下来等我们review并确定之后再继续开发工作。

![[raw/assets/98f0222d0101c244d6bd8de521c0ba0a_MD5.jpg]]

> ❌ 此时一个小插曲发生，Claude服务不可用了...

![[raw/assets/b25ef8abb758ed04fbe9f8a84e3eab09_MD5.jpg]]
...
![[raw/assets/90ae6d76f97a0178eef96ca273edb8f2_MD5.jpg]]
