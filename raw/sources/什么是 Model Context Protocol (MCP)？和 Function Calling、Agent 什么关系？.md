...
created: 2026-06-19
description: "MCP（Model Context Protocol）核心概念、四层分层架构、JSON-RPC 2.0 通信机制及生产级 MCP Server 开发实践。重点围绕 MCP 到底是什么？、MCP、Function Calling、Agent 到底是什么关系？、MCP 里到底有哪些东西？、一次 MCP 调用大概怎么走？"
tags:
  - source
  - mcp
  - javaguide
