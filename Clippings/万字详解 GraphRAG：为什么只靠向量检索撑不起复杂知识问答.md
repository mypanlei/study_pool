...
created: 2026-06-19
description: "深入解析 GraphRAG 核心概念，讲清楚知识图谱、实体、关系、社区发现、全局检索、局部检索，以及 GraphRAG 与传统向量 RAG 的本质区别和工程落地成本。重点围绕 什么是 RAG？、什么是 GraphRAG？、传统向量 RAG 有什么局限性？、GraphRAG 和传统向量 RAG 的本质区别 等内容展开。"
tags:
  - "clippings"
---
