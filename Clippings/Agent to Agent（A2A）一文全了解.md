...
created: 2026-06-18
description: "Agent to Agent（A2A）是 Google 近期推出的一种开放协议，旨在让不同框架和供应商的 AI Agents 能够互相通信和协作。> A2A 协议由 Google 于 2025年4月9日 开源发布，目前还在不断调整中。 什么是 Agent to Agent？Agent to Agent（A2A）"
tags:
  - "clippings"
---
