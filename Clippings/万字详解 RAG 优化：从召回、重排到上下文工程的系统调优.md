...
created: 2026-06-19
description: "深入拆解 RAG 优化的系统工程方法，覆盖 Chunk 策略、Metadata、Hybrid Search、Query Rewrite、Rerank、上下文压缩、答案评估与生产排查路径。重点围绕 RAG 优化到底在优化什么？、RAG 优化闭环、先做数据治理，再谈检索优化、Chunk 策略：别把知识切碎了 等内容展开。"
tags:
  - "clippings"
---
