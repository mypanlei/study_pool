...
created: 2026-06-19
description: "深入解析 Prompt Engineering 核心概念，涵盖四要素框架、六大核心技巧（角色扮演、思维链、少样本学习、任务分解、结构化输出、XML 标签与预填充）、高级工程技巧及企业级安全实践。重点围绕 什么是 Prompt？、Prompt 应该怎么写？、常用提示技巧有哪些？、复杂场景怎么处理？ 等内容展开。"
tags:
  - "clippings"
---
