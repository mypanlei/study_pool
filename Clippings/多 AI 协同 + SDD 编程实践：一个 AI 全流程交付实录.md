...
source: "https://zhuanlan.zhihu.com/p/2000568085258712069"
author:
  - "[[千问云​]]"
published:
created: 2026-06-30
description: "前言2025年以来，AI Coding技术正以前所未有的速度演进，在提升研发效能方面发挥着越来越重要的作用。Claude Code、CodeX、Gemini、Qwen Coder、Kimi K2等编码模型层出不穷，从智能补全到函数生成，再到端到端模块…"
tags:
  - "clippings"
---
51 人赞同了该文章
...
2025年以来，AI Coding技术正以前所未有的速度演进，在提升研发效能方面发挥着越来越重要的作用。Claude Code、 [CodeX](https://zhida.zhihu.com/search?content_id=269769759&content_type=Article&match_order=1&q=CodeX&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODI5Mjk2NzcsInEiOiJDb2RlWCIsInpoaWRhX3NvdXJjZSI6ImVudGl0eSIsImNvbnRlbnRfaWQiOjI2OTc2OTc1OSwiY29udGVudF90eXBlIjoiQXJ0aWNsZSIsIm1hdGNoX29yZGVyIjoxLCJ6ZF90b2tlbiI6bnVsbH0.UgyYBNnCqwLuM3MzFGLGLI2zwA2pc8CdSLVOrTSQDNY&zhida_source=entity) 、Gemini、Qwen Coder、 [Kimi K2](https://zhida.zhihu.com/search?content_id=269769759&content_type=Article&match_order=1&q=Kimi+K2&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODI5Mjk2NzcsInEiOiJLaW1pIEsyIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjY5NzY5NzU5LCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.8ujKqM5Ka3j2V0kXnNUt7frJqHTEKjR3ymU5E3W_GWI&zhida_source=entity) 等编码模型层出不穷，从智能补全到函数生成，再到端到端模块实现，AI Coding已深度融入日常研发流程。
...
所以 **使用AI仅靠“写得快”远远不够，关键在于“写得对”。** 要实现这一点，需要从依赖感觉的 [Vibe Coding](https://zhida.zhihu.com/search?content_id=269769759&content_type=Article&match_order=1&q=Vibe+Coding&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODI5Mjk2NzcsInEiOiJWaWJlIENvZGluZyIsInpoaWRhX3NvdXJjZSI6ImVudGl0eSIsImNvbnRlbnRfaWQiOjI2OTc2OTc1OSwiY29udGVudF90eXBlIjoiQXJ0aWNsZSIsIm1hdGNoX29yZGVyIjoxLCJ6ZF90b2tlbiI6bnVsbH0.wrx3W3M2l1nd8SJy6nwcKDnTReNhP8Eg6EWmfDDFF7g&zhida_source=entity) 过渡到一个强调规范、可复现、可靠交付的新阶段， **[SDD](https://zhida.zhihu.com/search?content_id=269769759&content_type=Article&match_order=1&q=SDD&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODI5Mjk2NzcsInEiOiJTREQiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNjk3Njk3NTksImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.2xBeiktlG4IQwzNhHJiaRFhSgM33D312CwlZAdYMKpg&zhida_source=entity) （Specification-Driven Development 规范驱动开发）** 正是这一转变的核心方法论，并且由 **多个 AI模型 协同工作** ，能力互补，避免受限于单一模型的能力边界。
...
目前主流的开源 SDD 工具有三种： **[Spec Kit](https://zhida.zhihu.com/search?content_id=269769759&content_type=Article&match_order=1&q=Spec+Kit&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODI5Mjk2NzcsInEiOiJTcGVjIEtpdCIsInpoaWRhX3NvdXJjZSI6ImVudGl0eSIsImNvbnRlbnRfaWQiOjI2OTc2OTc1OSwiY29udGVudF90eXBlIjoiQXJ0aWNsZSIsIm1hdGNoX29yZGVyIjoxLCJ6ZF90b2tlbiI6bnVsbH0.aw524RZjH_OIN2G0WzvjjVMNvwddZbPidjibcbhMyNU&zhida_source=entity) （GitHub）、BMAD（社区开源方法论）和 OpenSpec（Fission AI）** ，下面的表格表格总结了这三种工具的核心特点：

![](https://pic4.zhimg.com/v2-14d1d2c64d0133645a53e556590ddb23_1440w.jpg)
...
OpenSpec 是一个轻量级的 **命令行工具** ，它通过建立一套清晰的 **“提案->审查->实现->归档”** 流程，确保在写代码前， **人和AI就“要做什么”达成共识** 。
...
![](https://pica.zhimg.com/v2-60f08bae06566b65804da15595bf6bb6_1440w.jpg)

这里我的方法是 **通过 [MCP 协议](https://zhida.zhihu.com/search?content_id=269769759&content_type=Article&match_order=1&q=MCP+%E5%8D%8F%E8%AE%AE&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODI5Mjk2NzcsInEiOiJNQ1Ag5Y2P6K6uIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6MjY5NzY5NzU5LCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.CNpiDYL-_cMLCFArpMFi4RwfNd3bfoTf1DCEqSsdBq8&zhida_source=entity) 将 Codex 和 Gemini 作为工具（Tool）注入 Claude并通过全局规则约束** ，来实现 **Claude、Codex、Gemini 三位一体的无缝协作。** 我们只需向 **Claude 提出一个需求** ，它便会 **自动判断何时调用 Codex 编码、何时调用 Gemini 分析海量文档** ，并将三位 AI 的输出融合并完整交付——整个过程无需人工干预工具切换。

## AI模型的角色与分工

通过配置，我们为这三个模型设定了清晰的职责边界，让它们取长补短：

![](https://pic1.zhimg.com/v2-60fd3f985768d64c1bd38d77a62d38fc_1440w.jpg)
...
openspec init
```
![](https://pic4.zhimg.com/v2-118d2285bf427f53bd86fb98ac0543bd_1440w.jpg)
...
> 如果看到如下描述，说明安装成功！ codex: uvx --from git+ [github.com/GuDaStudio/c](https://link.zhihu.com/?target=https%3A//github.com/GuDaStudio/codexmcp.git) codexmcp - ✓ Connected

1.4 可选择默认允许claude code自动与codex交互，在~/.claude/settings.json添加 mcp\_\_codex\_\_codex allow项。

![](https://pic1.zhimg.com/v2-0db584d1b8d836ec00d4ea941b9707ca_1440w.jpg)
...
在Claude中调用 **系统架构专家 SubAgent** ，对现有代码库进行全面分析，输出一份清晰的系统架构文档，为后续AI生成技术方案提供参考基准。

![](https://pic3.zhimg.com/v2-7357aadf2784f161a08a27c284a662c0_1440w.jpg)

在走读代码库总结系统架构时，Claude也会调用CodeX来协作完善文档内容。

![](https://pic3.zhimg.com/v2-ba0f68d83da69a3a8b47a728ad1f6e3c_1440w.jpg)

最终产出文档

![](https://pic2.zhimg.com/v2-84b06da0bc0d1d9d9f293fff6044e817_1440w.jpg)

## 阶段三：生成技术方案

基于阶段一和阶段二中产出的 **系统架构文档 与 Spec-PRD** ，我们调用 **“技术方案专家” SubAgent** 自动生成一份技术方案文档，为后续 AI 编码阶段提供 **可执行、可验证的实现指引** ，确保开发过程“写得对”而非仅“写得快”。

![](https://pic4.zhimg.com/v2-e6cbf12380bcd58e700bffb32e27ab53_1440w.jpg)

## 阶段四：创建变更提案

在前置准备中我们已经将OpenSpec初始化后，OpenSpec已经在Claude中为我们安装好了3个关键Command。

![](https://pic1.zhimg.com/v2-b10d762b142e9745dfd617a4c96c65d6_1440w.jpg)
...
```
![](https://pic1.zhimg.com/v2-85c4477d093906f3a322944c2da81fea_1440w.jpg)
...
![](https://pic3.zhimg.com/v2-b39f5f3a29ab0712fb4b5b1d3747d12c_1440w.jpg)

回答完毕之后，ai会根据我们提供的明确答案继续创建提案。

![](https://pic4.zhimg.com/v2-6659defa5eb8f0ae83bb496de3bc7245_1440w.jpg)

此时将第一阶段写好的Spec-PRD的语雀链接给到claude，他会调用Yuque MCP读取内容并创建提案

> 💡 这里也可以把写好的Spec-PRD以MarkDown格式写好保存到本地，让Claude读取路径下的.md文件内容。

![](https://pic2.zhimg.com/v2-3a1932325ad29a0697dd765ec8831d4d_1440w.jpg)

了解完毕后，ai开始编写proposal提案。

![](https://pic1.zhimg.com/v2-9dece457f89c50d00501948303b30606_1440w.jpg)

即使前期我们将Spec-PRD、项目架构文档、技术文档给到ai作为参考资料编写提案，但ai大概率还是能发现遗漏的待确定点。

![](https://pic1.zhimg.com/v2-8538e059a78380892bbd5c4ea40dd634_1440w.jpg)

与ai进行1~2轮对话之后，ai会对需求（为什么做、怎么做，做哪里、范围、边界）有一个清晰的了解，并完善提案。

![](https://pic2.zhimg.com/v2-83bcc7255d0746184a99ff39c9668e57_1440w.jpg)
...
但是，仅依赖 Spec 并不足以确保高质量输出。为了避免 AI “一口气生成全部代码”导致错误累积、难以修复，我们在调用 Claude 前需要加上 **额外关键约束：要求 Claude 采用分阶段、交互式的开发模式。**
...
/openspec:apply
```
![](https://pic4.zhimg.com/v2-261da41d2b206b5db0f9de2862d74bd1_1440w.jpg)

完成每个阶段之后，Claude会总结当前阶段变更的代码，并停下来等我们review并确定之后再继续开发工作。

![](https://pic2.zhimg.com/v2-de65e351fb8002e17bfbbd00c53b2d35_1440w.jpg)

> ❌ 此时一个小插曲发生，Claude服务不可用了...

![](https://pic4.zhimg.com/v2-2532f6f9fb9789f94e021951974a5e3d_1440w.jpg)
...
![](https://pica.zhimg.com/v2-29bac2dffa8dc15391adbd2ce86d7d40_1440w.jpg)
...
> 搜索技术团队，公众号：阿里云开发者AI工程vs传统工程 —「道法术」中的变与不变

本次的SDD开发实践中，深切体会到： **AI 模型的输出天然带有概率性与模糊性** ——无论是单AI还是多AI协作，若放任其自由发挥，看似高效的“全自动编码”反而会引入难以追溯的隐性风险。 **Spec-Driven Development（SDD）是应对这一不确定性的关键** ，通过一份结构清晰的 **统一规范（Spec）** ，将原本分散的AI 能力（Claude、Codex、Gemini） **约束在同一套框架之下** 。

**这不是试图消除 AI 的不确定性，而是将其引导至一个可预测、可验证、可干预的轨道上。** 就像水利工程不靠堵水，而靠疏导入渠——SDD 通过规范对齐，让AI 的“概率输出”最终汇聚为“确定交付”。

**参考链接：**

发布于 2026-02-03 12:00・浙江[有了豆包学习搭子，作文、翻译、讲解，学习轻松无压力](http://www.doubao.com/download/desktop?ug_apk_token=LQqwd&ad_platform_id=zhihu_feed_lead&ug_callback_url=https%3A%2F%2Fsugar.zhihu.com%2Fplutus_adreaper_callback%3Fsi%3D5920e03c-93bd-4db9-9387-ad29c3ebb481%26os%3D3%26zid%3D1629%26zaid%3D3756217%26zcid%3D3751285%26cid%3D3751285%26event%3D__EVENTTYPE__%26value%3D__EVENTVALUE__%26ts%3D__TIMESTAMP__%26cts%3D__TS__%26mh%3D